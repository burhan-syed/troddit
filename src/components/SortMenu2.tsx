  ...
  return (
    ...
    >
      <div className="flex-grow w-full">
        <Menu.Button className="flex flex-row items-center justify-between w-full h-full px-2 bg-white border border-gray-300 dark:bg-trueGray-900 hover:bg-gray-50 focus:outline-none">
          <BsChevronDown
            className={
              show
                ? "rotate-180"
      ...
      >
        <Menu.Items
          className={
            "absolute right-0 w-40 mt-12 origin-top-right bg-white dark:bg-darkBG rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none border border-lightBorder dark:border-darkBorder " +
            (hide && " hidden")
          }
        >
          <div className="py-1">
            ...
            <Menu.Item>
              {({ active }) => (
                <div className="group" onClick={(e) => updateRange(e, "day")}>
                  <div
                    className={classNames(
                      active
                        ? "bg-gray-100 dark:bg-gray-500 text-gray-900"
